...
use crate::schemas::{QueryResponse, ValueType, KeyValuePair};
...
/// # Returns:
/// A SET_OK enum.
pub fn set_many(store: &mut BTreeMap<String, Vec<u8>>, key_value_pairs: Vec<KeyValuePair>) -> Result<QueryResponse, String> {
